...
<table width="100%">
  <tr>
    <td>
      ...
      • <a href="https://github.com/Devraj-jha/golang-webserver-no-deps">Go Webserver No Dependencies</a> - Lightweight web server built in Go-Lang without external dependencies and libraries<br>
